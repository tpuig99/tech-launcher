...
define(['frontend', 'services/postService'], function(frontend) {
    ...
    frontend.controller('PostCtrl', ["$scope", "$location", "$window", "$routeParams", "postService", "Restangular", function($scope, $location, $window, $routeParams, postService, Restangular) {
      $scope.isAdmin = true;
      $scope.isOwner = true;
