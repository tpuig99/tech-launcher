...
<div class="content-no-sidebar-left">
    <div class="title">
        <h1><spring:message code="post.edit_post"/></h1>
    </div>
    ...
    <form:form modelAttribute="editPostForm" action="${postPath}" method="post" id="editPostForm">
        ...
        <div class="d-flex justify-content-center mt-4">
            <a href="<c:url value="/posts/${editPostForm.postId}"/>" class="btn btn-danger mr-4"><spring:message code="button.cancel"/></a>

            <input class="btn btn-info" id="editPostButton" type="button" onclick="this.form.submit()" value="<spring:message code="button.submit"/>"/>
