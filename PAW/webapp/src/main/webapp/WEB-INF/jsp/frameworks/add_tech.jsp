...
<div class="content-no-sidebar">
    ...
    <form:form modelAttribute="frameworkForm" action="${postPath}" method="post" id="addTechForm">
        ...
        <div class="form-group">
            <spring:message code="add_tech.description.placeholder" var="techdesc_placeholder" />
        ...
        <div class="form-group">
            <spring:message code="add_tech.introduction.placeholder" var="techintro_placeholder" />
