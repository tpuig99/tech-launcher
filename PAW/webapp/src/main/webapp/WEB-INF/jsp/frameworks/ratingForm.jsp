...
<form:form modelAttribute="ratingForm" action="${postPath}" method="post">
    ...
    <form:radiobutton path="rating" class="star star-5" id="star-5" type="radio" name="star"/>
    <form:label path="rating" class="star star-5" for="star-5"/>
    <form:radiobutton path="rating" class="star star-4" id="star-4" type="radio" name="star"/>
    <form:label path="rating" class="star star-4" for="star-4"/>
    <form:radiobutton path="rating" class="star star-3" id="star-3" type="radio" name="star"/>
    <form:label path="rating" class="star star-3" for="star-3"/>
    <form:radiobutton path="rating" class="star star-2" id="star-2" type="radio" name="star"/>
    <form:label path="rating" class="star star-2" for="star-2"/>
    <form:radiobutton path="rating" class="star star-1" id="star-1" type="radio" name="star"/>
