        ...
        <c:when test="${param.username != 'anonymousUser'}">
            ...
            <c:choose>
                <c:when test="${!param.isEnable}">
                    <button class="btn btn-info" type="button"  data-toggle="modal" data-target="#confirmMailModal"><spring:message code="tech.rating.button"/></button>
                </c:when>
                <c:otherwise>
                    <button class="btn btn-info" type="submit"><spring:message code="tech.rating.button"/></button>
                </c:otherwise>
            </c:choose>
        </c:when>
        <c:otherwise>
            <button class="btn btn-info" type="button"  data-toggle="modal" data-target="#loginModal"><spring:message code="tech.rating.button"/></button>
        </c:otherwise>
    </c:choose>
</form:form>
</body>
