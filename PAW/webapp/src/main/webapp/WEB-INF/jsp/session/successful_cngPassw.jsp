...
<html>
    <head>
        <title><spring:message code="change_password.wref"/></title>
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="page-description">${message}<button class="btn btn-primary" onclick="continueOn()"><spring:message code="button.back_to_home"/></button></div>
        </div>
